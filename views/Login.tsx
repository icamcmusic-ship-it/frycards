...
const Login: React.FC = () => {
  const { loading, signInWithDiscord, signInAsGuest } = useGame();
          ...
          {loading ? (
            ...
            <div className="w-full flex flex-col gap-4">
              ...
              <button
                ...
                disabled={loading}
                className="group relative w-full py-4 overflow-hidden rounded-2xl bg-slate-800 hover:bg-slate-700 border border-slate-700 transition-all duration-300 active:scale-[0.98]"
              >
                <div className="relative flex items-center justify-center gap-3">
                  <span className="font-heading font-black text-slate-300 text-lg tracking-tight">
                    Play as Guest
                  </span>
                </div>
              </button>
