...
export const KEYWORD_GLOSSARY: Record<string, string> = {
  ...
  Command: 'Command X: Leader ability — pay X to instantly ready a friendly Unit for another attack (each Unit at most once per turn).',
  ...
  Feedback: 'When targeted: 4-6 on a d6 negates the effect and refunds the caster exactly what was spent.',
