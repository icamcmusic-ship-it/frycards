...
export const CARDS_V3: CardDef[] = [
  ...
  // ---- Events ----
  {
    id: 'fireball', name: 'Fireball', type: 'Event', threshold: 5,
  ...
  // ---- Locations ----
  {
    id: 'training_grounds', name: 'Training Grounds', type: 'Location', threshold: 3,
    locPassive: 'ATK_ALL', text: 'Your Units get +1 ATK.',
  },
  {
    id: 'sanctum', name: 'Verdant Sanctum', type: 'Location', threshold: 3,
    locPassive: 'HP_ALL', text: 'Your Units get +1 max HP.',
  },
  {
    id: 'dice_den', name: 'Dice Den', type: 'Location', threshold: 4,
...
export const CARD_DB: Record<string, CardDef> = Object.fromEntries(
  CARDS_V3.map((c) => [c.id, c]),
);

/** 40-card decklists (id -> copies, max 3) per Leader. */
export const DECKLISTS_V3: Record<string, Record<string, number>> = {
  leader_ember: {
    dice_goblin: 3, swift_fox: 3, pikeman: 3, berserker: 3, lancer: 3,
    spark: 3, bolt: 3, fireball: 3, phoenix: 3, twin_flames: 3,
    war_titan: 2, full_charge: 3, lucky_streak: 2, training_grounds: 1, tinker: 2,
  },
  leader_verdant: {
    shield_bearer: 3, wardancer: 3, field_medic: 3, tower_golem: 3, bulwark: 3,
    anchor_keeper: 3, anchorite: 3, salve: 3, insight: 3, annihilate: 3,
    war_titan: 3, shackles: 3, sanctum: 2, house_rules: 2,
  },
  leader_gearwright: {
    pair_prowler: 3, triad_mystic: 3, echo_shade: 3, insight: 3, tinker: 3,
    lucky_streak: 3, straight_shot: 3, full_charge: 3, rally_captain: 3,
    war_titan: 3, pikeman: 3, grand_slam: 1, jackpot: 1, shield_bearer: 3, house_rules: 2,
  },
  leader_shadow: {
    swift_fox: 3, echo_shade: 3, wardancer: 3, lancer: 3, shackles: 3,
    bolt: 3, spark: 3, phoenix: 3, berserker: 3, insight: 3,
    pikeman: 3, tinker: 3, siege_drake: 2, annihilate: 2,
  },
};
