...
export const ENTRIES: ChangelogEntry[] = [
  {
    ...
    items: [
      ...
      'Every card whose art is a looping video clip is now MYTHIC. The Mythic template is the video print: full-bleed footage behind a glowing gold inner frame with embers rising over it. Astral Shoal, Chrysalis of the Departed, Faye\'s True Face and Void Mother moved from Full-Art to Mythic.',
