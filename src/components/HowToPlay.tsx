...
const SECTIONS = [
  {
    ...
    body: [
      ['Win Condition', 'Reduce the enemy Leader\'s health to 0. Your Leader\'s printed health is your life total.'],
  ...
  },
  {
    ...
    body: [
      ...
      ['Lurk', 'Cannot be targeted by enemy attacks or Events (suppressed by Guard).'],
      ...
      ['Phalanx', 'Gains bonus stats for each other friendly card on your board.'],
      ...
      ['Rally X', 'Leader passive: Units you deploy costing X or less get +1/+1 this turn.'],
      ['Fate X', 'Expiring Charm: look at your top X cards, keep 1, bottom the rest.'],
      ['Glaciate X', 'When this Unit blocks, it Freezes the attacker — or deals X damage if the attacker is already Frozen.'],
      ['Scorched-Earth', 'When this Unit attacks and is blocked, all other enemy Units take 1 damage.'],
      ['Freeze-Dry', 'Deals +1 damage per other Frozen card on the battlefield.'],
      ['Blessed', 'Cannot be targeted or hit by enemy Dark or Chaos cards.'],
      ['Sustain X', 'Heals X damage at the very start of your turn.'],
      ['Glitch', 'Combat damage disables the target\'s abilities until Cleanup.'],
      ...
      ['Modularity X', 'Raises the host Unit\'s Item capacity.'],
  ...
  },
  {
    ...
    body: [
      ...
      ['Exhume [Type]', 'Return a card of the given type from your graveyard to your hand.'],
